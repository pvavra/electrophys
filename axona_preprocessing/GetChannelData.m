function [data_matrix, fileStats, packets_matrix] = GetChannelData(filename)
% [data_matrix, fileStats, packets_matrix] = GetChannelData(filename) 
...
%% calculate a few stats on data-file
fileStats = struct();
...
packets_matrix = fread(fileID, fileStats.sizeInBytes ,'int16=>int16'); 
