...
% `axona_io` functions and converts them into more usable structures.
% 
% Requires: 
...
%
%     spikes              ... Structure-array, containting following
%                             fields: header, timestamps, waveforms. The
%                             length of the array is `nTetrodes`.
% 
% see also:
